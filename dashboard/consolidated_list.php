							...
							<div class="card-body">
								<div class="row">
									...
									<div class="d-md-flex align-items-center">
										<div>
											<h4 class="card-title"><?php echo $lang['left1051'] ?></h4>
										</div>
									</div>
									<!-- column -->
										...
										<table id="zero_config" class="table table-striped">
											...
											<?php if(!$courierrow):?>
												...
												<?php foreach ($courierrow as $row):?>							
													...
													<td class="column100 column3" data-column="column3"><?php echo $row->comments;?></td>
													<td class="column100 column5" data-column="column5"><?php echo $row->r_dest;?>-<?php echo $row->r_address;?> </td>
