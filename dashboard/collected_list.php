									...
									<table id="demo-foo-addrow2" class="table table-striped table-hover toggle-circle" data-page-size="7">
										...
										<tbody id="projects-tbl">
											...
											<tr class="card-hover">	
												...
												<td>
													<a href="dash_driver_pickup.php?do=dash_driver_pickup&amp;action=pickup_driver&amp;id=<?php echo $row->id;?>" data-toggle="tooltip" data-placement="top" title="<?php echo $lang['booking-list11'] ?>" data-id="<?php echo $row->id;?>"><i style="color:#20c997" class="ti-truck"></i> <?php echo $lang['left1078'] ?> </a>
												</td>
											</tr>											
											<?php endforeach;?>
											<?php unset($row);?>
