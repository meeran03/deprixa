...
<head>
    ...
    <title><?php echo $lang['left1025'] ?> | <?php echo $core->site_name ?></title>
    <!-- Custom CSS -->
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
			...
			<!-- ============================================================== -->
				...
				<?php $track = $courier->order_quotes();?>
											...
											<div class="service-form">
												<div class="row">
													<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb10 ">
														<h3><?php echo $lang['left1026'] ?> </h3><br> <?php echo $lang['left1027'] ?> <strong><?php echo $track;?></strong>
													</div>
																...
																<div class="row">
																	<div class="col-sm-12 col-md-4">
																		<div class="form-group">
																			...
																			<input type="text" class="form-control is-valid" name="locker" value="<?php echo $user->locker;?>" readonly>
																		</div>
																	</div>
																</div>
																<div class="row">
													...
													<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
														<div class="form-group service-form-group">
															<label for="inputcontact" class="control-label col-form-label"><?php echo $lang['left1028'] ?></label>
															<input type="text"  class="form-control" value="<?php echo $row->fname;?> <?php echo $row->lname;?>" placeholder="" readonly required>
															<div class="form-icon"><i class="fa fa-user"></i></div>
														</div>
													</div>
													<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
														<div class="form-group service-form-group">
															<label for="inputcontact" class="control-label col-form-label"><?php echo $lang['left1029'] ?></label>
															<input type="email" class="form-control" name="email" value="<?php echo $row->email;?>" placeholder="" readonly required>
													...
													<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
														<div class="form-group service-form-group">
															<label for="inputcontact" class="control-label col-form-label"><i class="fa fa-link"></i> <?php echo $lang['left1030'] ?></label>
															<input type="text" class="form-control" name="url_product"  placeholder="" required>
													...
													<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 ">
														<div class="form-group service-form-group">
															<label for="inputcontact" class="control-label col-form-label"><?php echo $lang['left1031'] ?></label>
															<div class="select">
																<input type="text" class="form-control" name="r_dest" placeholder="-- <?php echo $lang['left1032'] ?> --" list="browsers01" autocomplete="off" required>
													...
													<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 ">
														<div class="form-group service-form-group">
															<label for="inputcontact" class="control-label col-form-label"><?php echo $lang['left1033'] ?></label>
															<input type="text" class="form-control" name="r_city" placeholder="" required>
													...
													<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 ">
														<div class="form-group service-form-group">
															<label for="inputcontact" class="control-label col-form-label"><?php echo $lang['left1034'] ?></label>
															<input type="text" class="form-control" name="r_phone" placeholder="" required>
													...
													<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
														<div class="form-group">
															<label for="inputcontact" class="control-label col-form-label"><?php echo $lang['left1035'] ?></label>
															<div class="select">
																<input class="form-control" name="your_purchase" placeholder="-- <?php echo $lang['left1036'] ?> --" list="browsers02" autocomplete="off">
																<datalist id="browsers02">
																	<option value="<?php echo $lang['left1037'] ?>"><?php echo $lang['left1037'] ?></option>
																	<option value="<?php echo $lang['left1038'] ?>"><?php echo $lang['left1038'] ?></option>
																</datalist>
															</div>
														</div>
													</div>
													...
													<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
														<div class="form-group">
															<label for="inputcontact" class="control-label col-form-label"><?php echo $lang['left1039'] ?></label>
															<div class="select">
																<input class="form-control" name="your_quote" placeholder="-- <?php echo $lang['left1036'] ?> --" list="browsers03" autocomplete="off">
																<datalist id="browsers03">
																	<option value="<?php echo $lang['left1040'] ?>"><?php echo $lang['left1040'] ?></option>
																	<option value="<?php echo $lang['left1041'] ?>"><?php echo $lang['left1041'] ?></option>
																</datalist>
															</div>
														</div>
														<input type="hidden" name="idquote" value="1">
														<input type="hidden" name="status_quote" value="Quotation">
														<input type="hidden" name="order_quote" value="<?php echo $track;?>">
													</div>
													<br>
													<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
														<button type="submit" name="doupdate" class="btn btn-default btn-block mb10"><?php echo $lang['left1042'] ?></button>
														<p><small><?php echo $lang['left1043'] ?></small></p>
													</div>
												</div>
											</div>
										</form>
									...
									<div class="col-sm-12 col-md-6">
                                        <div class="">
											<div class="feature-description">
												<h2><?php echo $lang['left1044'] ?></h2>
												<br><br><hr>
												<div class="img_s"><img src="<?php SITEURL ?>assets/images/alert/quote.jpg" alt=""></div>
												<!-- feature-left -->
												<div class="feature-left">
													<div class="feature-content">
														<p><i class="mdi mdi-check"></i>  <?php echo $lang['left1045'] ?></p>
													</div>
												</div>
												<!-- /.feature-left -->
												<!-- feature-left -->
												<div class="feature-left">
													<div class="feature-content">
														<p><i class="mdi mdi-check"></i>  <?php echo $lang['left1048'] ?></p>
													</div>
												</div>
												<!-- /.feature-left -->
												<!-- feature-left -->
												<div class="feature-left">
													<div class="feature-content">
														<p><i class="mdi mdi-check"></i>  <?php echo $lang['left1046'] ?></p>
													</div>
												</div>
												<!-- /.feature-left -->
												<hr>
												<p> <?php echo $lang['left1047'] ?></p>
											</div>
