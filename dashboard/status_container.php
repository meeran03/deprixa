    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- row -->
				<!-- Edit Shipment -->
				<?php switch(Filter::$action): case "status_container": ?>
							...
							<div class="card-body">
								...
								<form class="xform" id="admin_form" method="post">
									...
									<footer>
										...
										<a href="container.php?do=list_container" class="button button-secondary"><span><i class="ti-share-alt"></i></span> <?php echo $lang['status-ship11'] ?></a> 
									</footer>
								</form>
							</div>
						</div>
			...
			<?php echo Core::doForm("processStatusContainer");?> 
			<?php break;?>
			<?php endswitch;?>
